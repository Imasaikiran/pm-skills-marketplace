...
## Description
Design and optimize prompts for AI features
...
As an AI Product Manager, understanding prompt engineering for pms is critical for success in the rapidly evolving AI landscape.
